...
export function ExplicitIcon({ inline = false }: { inline?: boolean }) {
    return (
        <svg className={clsx("fill-foreground opacity-60", inline && "inline ml-1")} viewBox="0 0 9 9" width="10" height="10" aria-hidden="true">
