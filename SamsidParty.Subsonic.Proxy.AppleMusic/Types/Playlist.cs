    ...
    public class Playlist : Resource
    {
        ...
        public Subsonic.Common.Playlist ToSubsonicType()
        {
            return new Common.Playlist
            {
                ...
                Created = Attributes.DateAdded != DateTime.MinValue ? Attributes.DateAdded : DateTime.Today,
                Changed = Attributes.DateAdded != DateTime.MinValue ? Attributes.DateAdded : DateTime.Today,
